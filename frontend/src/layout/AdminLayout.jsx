...
import { FaUserFriends, FaCalendarAlt, FaUserCircle, FaSignOutAlt, FaChartBar, FaHome, FaSearch, FaClipboard, FaRegCalendarCheck, FaStethoscope, FaUser } from 'react-icons/fa';
        ...
        <div className="d-flex" style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
            ...
            <div className="bg-white border-end d-flex flex-column p-3" style={{ width: '250px' }}>
                ...
                <Nav className="flex-column gap-3">
                    ...
                    <Nav.Link onClick={() => navigate('/dashboard/admin/profile')} className="d-flex align-items-center gap-3 fs-5 text-dark">
            ...
            <div className="flex-grow-1 d-flex flex-column">
                ...
                <div className="bg-white px-4 d-flex justify-content-end align-items-center" style={{ height: '80px', paddingBottom: '0', marginBottom: '0' }}>
                    <Dropdown align="end">
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item onClick={() => navigate('/dashboard/admin/profile')}>View Profile</Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item
                                onClick={() => {
